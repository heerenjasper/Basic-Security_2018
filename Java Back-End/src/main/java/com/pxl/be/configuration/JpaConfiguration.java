package com.pxl.be.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.pxl.be.repositories",
...
public class JpaConfiguration {
	...
	/*
	 * Configure HikiariCP pooled DataSource 
	 */
	@Bean
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.pxl.be.model" } );
	...
	private Properties jpaProperties() {
		...
		properties.put("hibernate.hbm2ddl.auto", environment.getRequiredProperty("datasource.sampleapp.hibernate.hbm2ddl.method"));        properties.put("hibernate.show_sql", environment.getRequiredProperty("datasource.sampleapp.hibernate.show_sql"));
